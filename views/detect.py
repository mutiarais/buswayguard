...
st.set_page_config(layout="centered", page_title="BuswayGuard", page_icon=page_icon)
...
# Description
st.markdown("""Welcome to BuswayGuard, the platform for detecting gender and generating captions for flood images!""", unsafe_allow_html=True)
st.divider()
